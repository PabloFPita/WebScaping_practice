...
def download_and_save_data(data_url):
...
def main():
    ...
    indicativo = get_indicativo(all_stations, "MADRID, CIUDAD UNIVERSITARIA")
    if indicativo:
        print(f"Indicativo: {indicativo}")
        
        climatologia_url = get_climatologia_url(indicativo, "2019-10-01T00:00:00UTC", "2019-11-01T00:00:00UTC")
        data_url = get_climatologia_data(api_key, climatologia_url)
        
        print("URL to obtain the desired data:", data_url)
        
        download_and_save_data(data_url)
...
# No me deja hacer peticiones de más de 5 años.
# Response: {'descripcion': 'El rango de fechas no puede ser superior a 5 anios', 'estado': 404}
